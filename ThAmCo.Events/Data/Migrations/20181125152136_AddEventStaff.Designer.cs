...
namespace ThAmCo.Events.Data.Migrations
{
    ...
    [Migration("20181125152136_AddEventStaff")]
            ...
            modelBuilder.Entity("ThAmCo.Events.Data.Event", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Date = new DateTime(2016, 4, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), Duration = new TimeSpan(0, 6, 0, 0, 0), Title = "Bob's Big 50", TypeId = "PTY", isActive = true },
                        new { Id = 2, Date = new DateTime(2018, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Duration = new TimeSpan(0, 12, 0, 0, 0), Title = "Best Wedding Yet", TypeId = "WED", isActive = true }
                    );
                });
            ...
            modelBuilder.Entity("ThAmCo.Events.Data.Staff", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, FirstName = "Sam", Surname = "Shaw" },
                        new { Id = 2, FirstName = "Andrew", Surname = "Martin" },
                        new { Id = 3, FirstName = "Jeremy", Surname = "Osbourne" }
                    );
                });
