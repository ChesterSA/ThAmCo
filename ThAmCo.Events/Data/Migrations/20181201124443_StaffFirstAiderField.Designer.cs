...
namespace ThAmCo.Events.Data.Migrations
{
    ...
    [Migration("20181201124443_StaffFirstAiderField")]
    partial class StaffFirstAiderField
    {
            ...
            modelBuilder.Entity("ThAmCo.Events.Data.Event", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Date = new DateTime(2016, 4, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), Duration = new TimeSpan(0, 6, 0, 0, 0), IsActive = true, Title = "Bob's Big 50", TypeId = "PTY" },
                        new { Id = 2, Date = new DateTime(2018, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Duration = new TimeSpan(0, 12, 0, 0, 0), IsActive = true, Title = "Best Wedding Yet", TypeId = "WED" },
                        new { Id = 3, Date = new DateTime(2018, 10, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), Duration = new TimeSpan(0, 1, 0, 0, 0), IsActive = true, Title = "Best-er Wedding Yet", TypeId = "WED" }
                    );
                });
